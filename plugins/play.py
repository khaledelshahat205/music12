...
async def تشغيل(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🚨𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍🚨", url="t.me/XxvprxX "),
                    InlineKeyboardButton("ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧", url="t.me/XxlllllllllllllllllllllllllllxX"),
                ],
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🚨𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍🚨", url="https://t.me/XxvprxX "),
                        InlineKeyboardButton(" ᯓ˹ 𝐕𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢）⛧", url="t.me/XxlllllllllllllllllllllllllllxX"),
                    ],
                    [InlineKeyboardButton(text="🗑 حذف", callback_data="cls")],
                ]
