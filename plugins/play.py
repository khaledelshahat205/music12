...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<b>هناك مشكلة لم استطيع دعوة الحساب المساعد ارسل الامر ( /userbotjoin ) حتا ينضم او قم بي اضافتة يدويا @XxVPlllllllllxX</b>"
        )
        return
    ...
    if audio:
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("ᯓ˹ ??𝘼𝙈𝘽𝙄𝙍𖣥⃟⃟⃟⃟⃟🇵🇸فمـبــيرـ͢", url=f"t.me/XxlllllllllllllllllllllllllllxX"),
                        InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄🌀", url=f"t.me/XxvprxX"),
                    ],
                    [InlineKeyboardButton(text="اغلاق القائمة", callback_data="cls")],
                ]
            ...
            title = "@XxlllllllllllllllllllllllllllxX"
            thumb_name = "https://telegra.ph/file/cd0b87484429704c7b935.png"
