...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"حدث خطأ ما\n{Exception}\n\nيرجي اعادة توجية هذة الرسالة الي المطور @smsmfff\n\nقم بي اضافه الحساب المساعد يدويا @smsmCommm")
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    except:
        await lel.edit(
            f"<b>هناك مشكلة لم استطيع دعوة الحساب المساعد ارسل الامر ( /userbotjoin ) حتا ينضم او قم بي اضافتة يدويا @smsmCommm</b>"
        )
        return
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ♪", url=f"t.me/smsmfff"),
