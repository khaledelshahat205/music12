...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    Image.alpha_composite(image5, image6).save("temp.jpg")
...
async def تشغيل(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("قـنـاه اݪسۅࢪس", url="t.me/XxvprxX "),
                    InlineKeyboardButton("مبࢪمج اݪسۅࢪس", url="t.me/XxlllllllllllllllllllllllllllxX"),
                ],
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("قـنـاه اݪسۅࢪس", url="https://t.me/XxvprxX "),
                        InlineKeyboardButton(" مبࢪمج اݪسۅࢪس", url="t.me/XxlllllllllllllllllllllllllllxX"),
                    ],
                    [InlineKeyboardButton(text="🗑 حذف", callback_data="cls")],
                ]
