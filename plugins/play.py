...
async def تشغيل(_, message: Message):
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("قـنـاه اݪسۅࢪس", url="t.me/NN_N_NM"),
                    InlineKeyboardButton("مبࢪمج اݪسۅࢪس", url="t.me/HR_BY"),
                ],
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("قـنـاه اݪسۅࢪس", url="https://t.me/NN_N_NM"),
                        InlineKeyboardButton(" مبࢪمج اݪسۅࢪس", url="t.me/HR_BY"),
                    ],
                    [InlineKeyboardButton(text="🗑 حذف", callback_data="cls")],
                ]
