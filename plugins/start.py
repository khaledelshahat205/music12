...
⌁ ⁞   Developed By [๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ♪♪♪🔖🖇 🔱](https://t.me/smsmfff)!**
</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🔮ⓜⓤⓢⓘⓒ🔮", url="https://t.me/smsmCommm")
                  ],[
                  InlineKeyboardButton(
                        "๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ♪♪♪🔖🖇 🔱", url="https://t.me/smsmfff")
                  ],[
                    InlineKeyboardButton(
                       "𝐒𝐎𝐔𝐑𝐂𝐄🌀", url="https://t.me/XxvprxX"
                    ),
                    InlineKeyboardButton(
                        "🚨ⒷⒶⓇ🚨", url="https://t.me/smsmXxxxx"
                    )
                ],[
                    InlineKeyboardButton(
...
- رفض إرسال رسالة إلى المساعد في الخاص.
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ𝑺๖ۣۜ𝑴๖ۣۜ♪♪♪🔖🖇 🔱", url=f"https://t.me/smsmfff"
                    )
                ]
            ]
        )
